"""
Upload the fine-tuned US construction model to HuggingFace Hub.
Run after training: python training/push_to_hub_us.py
"""
...
REPO_NAME   = "costpilot-cost-parser-us"
PRIVATE     = False   # public so HF Spaces can load without a token

def main():
    if not MODEL_DIR.exists():
        print(f"ERROR: Model not found at {MODEL_DIR}")
        print("Run  python training/train_us.py  first.")
        sys.exit(1)
